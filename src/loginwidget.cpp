 ...
 * \brief Contains loginWidget class definition
 *
 * Main login page. User can login with his account, login as a guest
...
/**
 * @brief loginWidget::checkLogin
 *
 * Check if login conditions are met, and login with a particular user
 */
...
/**
 * @brief loginWidget::GoToRegisterPage
 *
...
/**
 * @brief loginWidget::GoToMainAsGuest
 *
 * Open main menu as a guest
 */
